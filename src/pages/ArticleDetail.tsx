...
import { getArticleBySlug, getNextArticleSlug } from '@/data/articles'
...
export default function ArticleDetail() {
  ...
  const nextSlug = getNextArticleSlug(article.slug)
      ...
      <section className="bg-white py-10 lg:py-16">
        <div className="mx-auto flex w-[92%] flex-col gap-12 md:w-[85%] lg:gap-20">
          <div className="flex flex-col items-start gap-8 lg:flex-row lg:gap-[80px] xl:gap-[127px]">
            ...
            <p className="w-full max-w-[337px] shrink-0 text-body-md tracking-[-0.32px] text-body">
              {article.body[0]}
            </p>
          </div>

          <div className="flex flex-col items-start gap-8 lg:flex-row lg:items-end lg:justify-between">
            <p className="w-full max-w-[337px] text-body-md tracking-[-0.32px] text-body">
              {article.body[1]}
            </p>
            <p className="w-full max-w-[337px] text-body-md tracking-[-0.32px] text-body">
              {article.body[2]}
