...
export default function RegardsCroises() {
  return (
    <div className="page">
      ...
      <USection>
        <UCard image="/assets/gallery-13-4246.jpg" alt="Regards croisés" height="500px" wrapperClass="mb-12" />
        <div className="max-w-[800px] space-y-6 text-body-md text-dark">
          <p>
            Le projet "Regards croisés" vise à faciliter et à valoriser la compréhension mutuelle
            entre les cultures française et béninoise. À travers une série d'échanges, de témoignages
            et d'initiatives conjointes, ce programme met en lumière des initiatives et des acteurs
            qui œuvrent pour le développement au Bénin.
          </p>
          <p>
            En encourageant le dialogue interculturel et la collaboration entre les deux pays, le
            projet crée des ponts durables qui favorisent non seulement le partage de connaissances,
            mais aussi la mise en œuvre de projets concrets bénéficiant aux communautés locales.
          </p>
          <p>
            Les partenariats établis dans le cadre de ce programme s'inscrivent dans une logique de
            développement durable et d'impact social positif pour les populations béninoises.
          </p>
        </div>
        <div className="grid grid-cols-3 gap-4 mt-12">
          <img src="/assets/gallery-13-4246.jpg" alt="" className="rounded-card object-cover" style={{ height: 150 }} />
          <img src="/assets/gallery-13-4250.jpg" alt="" className="rounded-card object-cover" style={{ height: 150 }} />
          <img src="/assets/hero-bg.jpg" alt="" className="rounded-card object-cover" style={{ height: 150 }} />
        </div>
      </USection>
