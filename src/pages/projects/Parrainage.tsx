...
export default function Parrainage() {
  return (
    <div className="page">
      ...
      <USection>
        <UCard image="/assets/gallery-13-4250.jpg" alt="Le parrainage" height="500px" wrapperClass="mb-12" />
        <div className="max-w-[800px] space-y-6 text-body-md text-dark">
          <p>
            Le programme de parrainage d'Alliance Actions Afrique connecte les étudiants béninois
            avec des professionnels français. Ce programme offre des échanges réguliers, du mentorat
            personnalisé et un accompagnement vers l'autonomie professionnelle.
          </p>
          <p>
            À travers des séances de formation et des sessions de conseil, les étudiants bénéficient
            d'un suivi individualisé qui les aide à définir leur parcours professionnel, à développer
            des compétences clés et à préparer leur insertion sur le marché du travail.
          </p>
          <p>
            Le parrainage constitue un pilier essentiel de l'engagement d'Alliance Actions Afrique,
            en favorisant des liens humains forts et durables entre les deux rives de la
            Méditerranée.
          </p>
        </div>
      </USection>
