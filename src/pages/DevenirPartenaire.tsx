...
export default function DevenirPartenaire() {
  ...
  return (
    <div className="page pt-28">
      <PageTitle title="Construisons un partenariat à impact" />
      ...
      <section className="bg-white py-10 lg:py-16 overflow-hidden" data-aos="fade-up">
        <div className="mx-auto flex w-[92%] max-w-[1001px] flex-col items-center gap-[50px] md:w-[85%]">
          {/* Intro banner */}
          <div
            className="w-full rounded-[12px] bg-[#f5f0eb] px-6 py-8 text-center sm:px-10 sm:py-10"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
            <p className="mx-auto max-w-[780px] text-body-md tracking-[-0.32px] text-dark">
              Entreprises, fondations ou organisations, rejoignez Alliance Actions Afrique pour
              développer des projets porteurs de changement. Partagez avec nous votre projet ou vos
            ...
            <div className="flex w-full flex-col gap-10">
              ...
              >
                ...
                <textarea
                  ...
                  aria-label="Message/Motivations"
                />
              </label>
            </div>
