...
export default function Projects() {
  return (
    <div className="page">
      <DarkHero title="Nos projets phares" />
        ...
        <div className="space-y-16">
          {projects.map((project) => (
            <Link
              key={project.id}
              to={project.route}
              className="flex items-center gap-12 cursor-pointer group no-underline"
            >
              <div className="flex-1 rounded-card overflow-hidden" style={{ height: 300 }}>
